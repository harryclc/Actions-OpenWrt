...
wget -qO- https://raw.githubusercontent.com/vernesong/OpenClash/core/master/dev/clash-linux-amd64.tar.gz | tar xOvz > package/base-files/files/etc/openclash/core/clash
